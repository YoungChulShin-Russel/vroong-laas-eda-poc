...
import vroong.laas.readmodel.handler.DeliveryProjectionHandler;
import vroong.laas.readmodel.handler.DispatchProjectionHandler;
import vroong.laas.readmodel.handler.OrderProjectionHandler;
...
public class ProjectionOrchestrator {
    ...
    public void handleOrderEvent(OrderEvent orderEvent) {
        ...
        try {
            ...
            OrderProjection projection = orderProjectionHandler.handleOrderEvent(orderEvent);
    ...
    public void handleDispatchEvent(DispatchEvent dispatchEvent) {
        ...
        try {
            // 1. 기존 projection 조회
            Optional<OrderProjection> existingProjection = 
    ...
    public void handleDeliveryEvent(DeliveryEvent deliveryEvent) {
        ...
        try {
            ...
            // 2. 기존 projection 조회
            Optional<OrderProjection> existingProjection = projectionService.getOrderProjection(orderId);
            ...
            // 3. Delivery 상태 업데이트
            OrderProjection updatedProjection = deliveryProjectionHandler.updateDeliveryStatus(
