package vroong.laas.order.core.service.domain.address;
...
public class AddressRefiner {
  ...
  private final AddressRefineClient addressRefineClient;
  ...
  public Address refine(LatLng latLng, Address originalAddress) {
    return addressRefineClient.refineByReverseGeocoding(latLng, originalAddress);
  }
}
